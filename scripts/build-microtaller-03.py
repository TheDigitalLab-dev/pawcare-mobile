#!/usr/bin/env python3
"""Genera docs/microtaller-03-actividad.docx a partir de docs/microtaller-03-actividad.md
...
SIN portada (la maqueta el usuario). Soporta encabezados, listas, **negrita**,
tablas markdown y bloques de codigo ```...```.
"""
import re
...
SRC = ROOT / "docs" / "microtaller-03-actividad.md"
OUT = ROOT / "docs" / "microtaller-03-actividad.docx"
