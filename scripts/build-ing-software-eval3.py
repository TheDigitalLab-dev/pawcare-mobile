#!/usr/bin/env python3
"""Genera docs/ing-software/eval-3-miguel-figuera.docx a partir de docs/ing-software/eval-3-miguel-figuera.md
...
con C.I., tutor y ciudad-fecha; sin numero de pagina en la portada).
...
SRC = ROOT / "docs" / "ing-software/eval-3-miguel-figuera.md"
OUT = ROOT / "docs" / "ing-software/eval-3-miguel-figuera.docx"
...
PORTADA = {
    ...
    "titulo": "Evaluación 3: Fase de Diseño del Producto de Software",
    "integrantes": [
